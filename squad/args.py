...
def add_train_test_args(parser):
    ...
    parser.add_argument('--char_cnn_out_channels',
                        type=int,
                        default=50,
                        help='Number of filter matrices per width; \
                        can be any integer between 25 and 100.')
    parser.add_argument('--char_cnn_max_filter_width',
                        type=int,
                        default=7,
                        help='Maximum width of character CNN filter matrices.')
